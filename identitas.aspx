<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="identitas.aspx.cs" Inherits="MyProject.identitas" %>
...
<head runat="server">
    ...
    <!-- CSS Eksternal -->
    <link rel="stylesheet" href="assets/css/identitas.css">
...
<body>
    ...
    <div class="tabs">
        ...
        <div class="tabs__content">
            <ul>
                <li>Nama Sekolah: SMKN 1 Jakarta</li>
                <li>NPSN: <a
                        href="https://smkn1jakarta.sch.id/wp-content/uploads/2022/04/NPSN-SMKN-1-JKT.jpeg">20100143</a>
                </li>
                <li>NSS: 321016002004</li>
                <li>NIS: 40056</li>
                <li>Alamat Sekolah: <br> <br> Jl. Budi Utomo No. 7 RT.004 RW.008, Kel. Pasar Baru
                    Kec. Sawah Besar Jakarta Pusat
                    Provinsi Daerah Khusus Ibukota
                    Jakarta 10710</li>
                <li>Telepon: 021-3813630 / (021) 350 4091</li>
                <li>Email: <a href="mailto:smkn1jakarta@gmail.com">smkn1jakarta@gmail.com</a></li>
            </ul>
        </div>
        <input type="radio" class="tabs__radio" name="tabs-example" id="tab2">
        <label for="tab2" class="tabs__label">Bidang Keahlian</label>
        <div class="tabs__content">
            <ol class="bidang-keahlian">
                <p>Bidang Keahlian:</p>
                <li>Teknologi dan Rekayasa</li>
                <li>Teknologi Informasi dan Komunikasi</li><br> <br>
            </ol>
            <ol class="program-studi">
                <p>Program Studi Keahlian:</p>
                <li>Teknik Komputer dan Informatika</li>
                <li>Teknik Mesin</li>
                <li>Teknik Bangunan</li>
